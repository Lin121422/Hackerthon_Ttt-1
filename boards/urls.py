...
urlpatterns = [
	...
	path('<int:board_id>/topic/<int:topic_id>/closeTopic/', boards.views.close_topic, name='closetopic'),  # close topic page
	path('<int:board_id>/topic/<int:topic_id>/openTopic/', boards.views.reopen_topic, name='opentopic'),  # open topic page
